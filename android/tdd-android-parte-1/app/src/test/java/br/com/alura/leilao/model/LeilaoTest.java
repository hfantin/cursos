...
public class LeilaoTest {
    ...
    @Test
    public void deve_DevolveTresMaioresLances_QuandoNaoReceberLances(){
        List<Lance> tresMaioresLances = CONSOLE.tresMaioresLances();
        assertEquals(0, tresMaioresLances.size());
    }

    @Test
    public void deve_DevolveTresMaioresLances_QuandoRecebeApenasUmLance(){
        CONSOLE.propoe(new Lance(ALEX, 200.0));
        List<Lance> tresMaioresLances = CONSOLE.tresMaioresLances();
    ...
    @Test
    public void deve_DevolveTresMaioresLances_QuandoRecebeApenasDoisLances(){
    ...
    @Test
    public void deve_DevolveTresMaioresLances_QuandoRecebeExatosQuatroLances(){
        CONSOLE.propoe(new Lance(ALEX, 200.0));
        CONSOLE.propoe(new Lance(new Usuario("Fran"), 300.0));
        CONSOLE.propoe(new Lance(ALEX, 400.0));
        CONSOLE.propoe(new Lance(ALEX, 100.0));
