...
public class PublicacaoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null){
            ...
            MyLog.i("PublicacaoAdapter.getView() - criou uma nova linha!!!");
        }else{
            holder = (ViewHolder) convertView.getTag();
            MyLog.i("PublicacaoAdapter.getView() - aproveitou a linha!!!");
        }

        Publicacao publicacao = (Publicacao) getItem(position);
        // usando o holder para popular o layout
        ...
        Picasso.with(this.context)
                ...
                .into(holder.foto, new VerificadorDeRetorno(holder.progress))
                ;
