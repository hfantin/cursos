...
public class ServidorTarefasV4 {
    ...
    public ServidorTarefasV4() throws IOException {
        System.out.println("--- Iniciando Servidor ---");
        this.servidor = new ServerSocket(12345);
        this.poolDeThreads = Executors.newCachedThreadPool(r -> fabricaDeThreads(r));
...
//        Thread thread = new Thread(r, "Thread-Servidor-Tarefas-" + numero);
    ...
    private void executar(Socket socket, ServidorTarefasV4 servidorTarefas) {
            ...
            while (entradaCliente.hasNextLine()) {
                ...
                switch (comando) {
                    ...
                    case "c3":
                        ...
                        saidaCliente.println("Comando c3 adicionada na fila");
                        break;
                    case "fim":
...
//        System.out.println("---------------------------------------------");
    ...
    public static void main(String[] args) throws IOException {
        ServidorTarefasV4 servidorTarefas = new ServidorTarefasV4();
